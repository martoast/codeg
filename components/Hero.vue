      ...
      >
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">CODEG</span>
            <img class="h-14 w-auto" src="/logo.jpg" alt="" />
          </a>
        </div>
        ...
        <div class="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            href="https://www.instagram.com/codeg.a.c?igsh=MTRnMTRxOHNyMjB4dg=="
            target="_blank"
            rel="noopener noreferrer"
            class="inline-flex items-center gap-x-2 rounded-lg px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-gray-100 transition-colors"
          >
        ...
        >
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              ...
              <div class="py-6">
                <a
                  href="https://www.instagram.com/codeg_gt"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          >
            ...
            >
              <div class="relative w-full lg:max-w-xl lg:shrink-0 xl:max-w-2xl">
                ...
                >
                  Comunidad para el Desarrollo Generacional
                </h1>
                <p
                ...
                <div class="mt-10 flex items-center gap-x-6">
                  ...
                  <a href="#" class="text-sm/6 font-semibold text-gray-900"
                    >Conoce más <span aria-hidden="true">→</span></a
                  >
                </div>
              </div>
              <div
