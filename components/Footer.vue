<template>
    <footer class="mt-16 sm:mt-32">
      <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-600">&copy; 2025 CODEG, Inc. All rights reserved.</p>
      </div>
    </footer>
</template>
...
const footerNavigation = {
  ...
  social: [
    ...
    {
      name: 'Instagram',
      href: 'https://www.instagram.com/codeg.a.c/?utm_source=ig_web_button_share_sheet',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
